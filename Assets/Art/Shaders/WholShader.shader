        ...
        Pass
        {
            ...
            #include "UnityCG.cginc"
                ...
                v2f vert(appdata v)
                {
                    v2f o;
                    o.pos = v.vertex;
                    o.pos.xyz += normalize(v.normal.xyz) * _OtlWidth * 0.008 * (1.1 * (_Time.y % 0.5));
                    o.pos = UnityObjectToClipPos(o.pos);
                    float c = smoothstep(-1.0, 1.0, sin(3.141 * v.normal.z + _Time.w)); //todo
                    o.color = _Color * (1.0 - c) + _TopColor * c;
                    float t = 0.5 - _Time.y % 0.5;
                    o.color.a *= _Alpha * (t + 0.5) * clamp(2.5 - 5.0 * t, 0.0, 1.0);
                    return o;
                }
        ...
        Pass
        {
            ...
            #include "UnityCG.cginc"
                ...
                v2f vert(appdata v)
                {
                    ...
                    float c = smoothstep(-1.0, 1.0, sin(3.141 * v.normal.z + _Time.w)); //todo
                    o.color = _Color * (1.0 - c) + _TopColor * c;
                    o.color.a *= _Alpha * (0.5 - _Time.y % 0.5);
                    return o;
                }
                ...
                ENDCG
                    ...
                    Pass
                    {
                        ...
                        v2f vert(appdata_base v)
                        {
                            ...
                            //o.color.a *= (0.5 - 0.5 * v.normal.z) * _Alpha;
                            return o;
                        }
